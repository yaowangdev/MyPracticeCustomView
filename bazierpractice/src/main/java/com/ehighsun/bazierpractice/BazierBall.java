...
public class BazierBall extends View {
    private Path mPath;
    ...
    public BazierBall(Context context) {
        this(context, null, 0);
    }

    public BazierBall(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BazierBall(Context context, AttributeSet attrs, int defStyleAttr) {
